...
import styles from "../../styles/Outline/Header.module.scss";
...
const navigate = useRouter()
  ...
  return (
    <header className={styles.header}>
      <nav style={navigate.pathname === "/orderNowModelS" ? {position:"unset"}: {position:"absolute"}}>
        ...
        <ul style={navigate.pathname === "/orderNowModelS" ? {display:"none"}: null} className="main-navigation">
          <li>
        ...
        <ul style={navigate.pathname === "/orderNowModelS" ? {display:"none"}: null} className="secondary-navigation">
          <li>
            <Link href="#">Shop</Link>
          </li>
          <li>
        ...
        <span className={styles.languagePicker} style={navigate.pathname === "/orderNowModelS" ? {display:"flex"}: {display:"none"}}><TfiWorld/> US</span>
          <span className={styles.respMenu} onClick={() => setActive(!active)}>Menu</span>
      </nav>
    </header>
  );
};
